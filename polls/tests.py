...
class QuestionModelTests(TestCase):
    ...
    def test_is_published_with_previous_question(self):
        """is_published() returns True for question that pub_date is in the past."""
    ...
    def test_is_published_with_upcoming_question(self):
        """is_published() returns False for question that pub_date is in the future."""
    ...
    def test_can_vote_with_previous_question(self):
        """can_vote() returns False for question that closed."""
